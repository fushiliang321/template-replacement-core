 ...
 * @returns {any}
 */
export function replace_params_encode(params) {
    const ret = wasm.replace_params_encode(params);
    return ret;
}
 ...
 * @returns {any}
 */
export function replace_params_encode_multiple_params(params) {
    const ret = wasm.replace_params_encode_multiple_params(params);
    return ret;
}
